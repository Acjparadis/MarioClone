...
public abstract class Enemy extends DestructibleEntity {
    ...
    public Enemy(Image image, int[] position, Image death, int scale, int deathTimeMax){
        super(image, position, death, deathTimeMax);
        speed = scale;
        gravity = scale*3/4;
    }

    public abstract void gameloop(int[] playerPosition);
